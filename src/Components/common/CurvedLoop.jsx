...
const CurvedLoop = ({
  ...
  return (
    <div
      className="min-h-30 flex items-center justify-center w-full border-b-2"
      style={{ visibility: ready ? "visible" : "hidden", cursor: cursorStyle ,overflow:"hidden",}}
    ...
    >
      <svg
        className="select-none w-full  block  text-[1rem] font-bold tracking-[5px] uppercase leading-none"
        viewBox="0 0 1440 70"
      >
        <text
          ref={measureRef}
